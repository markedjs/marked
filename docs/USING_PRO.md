...
<dt><code><strong>hooks.emStrongMask</strong>(<i>string</i> src)</code></dt>
<dd>A function that masks part of the content that should not be interpreted as Markdown em/strong delimiters. It may be used if the content may contain characters that could be misinterpreted as terminating inline blocks that should contain the extended token, such as <code>*</code> or <code>_</code>.</dd>
