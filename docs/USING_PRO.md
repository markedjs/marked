...
`marked.use()` can be called multiple times with different `walkTokens` functions. Each function will be called in order, starting with the **last** function that was assigned.
...
<dt><strong><code>start(<i>string</i> src)</code></strong></dt>
...
<dt><strong><code>tokenizer(<i>string</i> src, <i>array</i> tokens)</code></strong></dt>
...
The return value should be an object with the following parameters:
  ...
  <dt><strong><code>tokens [optional]</code></strong></dt>
...
The tokenizer function has access to the lexer in the `this` object, which can be used if any internal section of the string needs to be parsed further, such as in handling any inline syntax on the text within a block token. The key functions that may be useful include:
  ...
  <dl>
  <dt><strong><code>this.blockTokens(<i>string</i> text)</code></strong></dt>
  ...
  <dt><strong><code>this.inlineTokens(<i>string</i> text)</code></strong></dt>
...
<dt><strong><code>renderer(<i>object</i> token)</code></strong></dt>
...
The renderer function has access to the parser in the `this` object, which can be used if any part of the token needs needs to be parsed further, such as any child tokens. The key functions that may be useful include:
  ...
  <dl>
  <dt><strong><code>this.parse(<i>array</i> tokens)</code></strong></dt>
  ...
  <dt><strong><code>this.parseInline(<i>array</i> tokens)</code></strong></dt>
...
<dt><strong><code>childTokens [optional]</code></strong></dt>
