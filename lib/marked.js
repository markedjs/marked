...
(function (global, factory) {
  ...
  var Tokenizer_1 = /*#__PURE__*/function () {
    ...
    _proto.space = function space(lexer, src, tokens, top) {
    ...
    _proto.code = function code(lexer, src, tokens, top) {
    ...
    _proto.fences = function fences(lexer, src, tokens, top) {
    ...
    _proto.heading = function heading(lexer, src, tokens, top) {
    ...
    _proto.nptable = function nptable(lexer, src, tokens, top) {
    ...
    _proto.hr = function hr(lexer, src, tokens, top) {
    ...
    _proto.blockquote = function blockquote(lexer, src, tokens, top) {
    ...
    _proto.list = function list(lexer, src, tokens, top) {
    ...
    _proto.html = function html(lexer, src, tokens, top) {
    ...
    _proto.def = function def(lexer, src, tokens, top) {
    ...
    _proto.table = function table(lexer, src, tokens, top) {
    ...
    _proto.lheading = function lheading(lexer, src, tokens, top) {
    ...
    _proto.paragraph = function paragraph(lexer, src, tokens, top) {
    ...
    _proto.text = function text(lexer, src, tokens, top) {
    ...
    _proto.escape = function escape(lexer, src, tokens) {
    ...
    _proto.tag = function tag(lexer, src, tokens) {
    ...
    _proto.link = function link(lexer, src, tokens) {
    ...
    _proto.reflink = function reflink(lexer, src, tokens) {
      var cap;
      ...
      if ((cap = this.rules.inline.reflink.exec(src)) || (cap = this.rules.inline.nolink.exec(src))) {
        ...
        this.inLink = true;
        var token = outputLink(cap, link, tokens, cap[0], lexer);
        this.inLink = false;
        return token;
      }
    };

    _proto.strong = function strong(lexer, src, tokens) {
    ...
    _proto.em = function em(lexer, src, tokens) {
    ...
    _proto.codespan = function codespan(lexer, src, tokens) {
    ...
    _proto.br = function br(lexer, src, tokens) {
    ...
    _proto.del = function del(lexer, src, tokens) {
    ...
    _proto.autolink = function autolink(lexer, src, tokens) {
    ...
    _proto.url = function url(lexer, src, tokens) {
      var cap;
    ...
    _proto.inlineText = function inlineText(lexer, src, tokens) {
