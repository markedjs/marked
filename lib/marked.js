...
(function (global, factory) {
  ...
  var Tokenizer_1 = /*#__PURE__*/function () {
    ...
    _proto.list = function list(src) {
      ...
      if (cap) {
        ...
        while (src) {
          if (this.rules.block.hr.exec(src)) {
  ...
  block.bullet = /(?:[*+-]|\d{1,9}[.)])/; // block.item = /^( {0,3})(bull)( [^\n]*(?:\n(?! {0,3}bull )[^\n]*)*\n?)/;
      ...
      while (src) {
        ...
        if (token = this.tokenizer.list(src)) {
          ...
          for (i = 0; i < l; i++) {
            ...
            if (token.items[i].tokens.some(function (t) {
              return t.type === 'space';
            })) {
              token.loose = true;
  ...
  marked.use = function () {
    ...
    var opts = merge$2.apply(void 0, [{}].concat(args));
