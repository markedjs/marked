 ...
 *
 * `heading` is for [ATX headings](http://spec.commonmark.org/0.28/#atx-headings) (#) while
 * `lheading` is for [Setext heading](http://spec.commonmark.org/0.28/#setext-headings) (=, _)
 *
 ...
 * GFM Block Grammar
 *
 * GFM uses the CommonMark spec as a base, which it then extends.
 *
